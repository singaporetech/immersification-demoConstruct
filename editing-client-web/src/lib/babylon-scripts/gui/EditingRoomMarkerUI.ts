...
export class EditingRoomMarkerUI{
    private static instance: EditingRoomMarkerUI | null
    ...
    constructor(){
        ...
        if(EditingRoomMarkerUI.instance){
            EditingRoomMarkerUI.instance.Uninit()
            EditingRoomMarkerUI.instance = null
        }
        EditingRoomMarkerUI.instance = this
    }
    ...
    NewMarkerEventCallback(event: NewMarkerEvent){
        const _this = EditingRoomMarkerUI.instance as EditingRoomMarkerUI
        ...
        newImage.onPointerUpObservable.add((pointInfo, eventState)=>{
            ...
            if(eventState.target === newImage){
                ServerObjectManager.instance?._RequestDeleteMarker(newImage.metadata.markerId)
            }
        })
    ...
    _HandleMarkerTypeSelection(markerType: number){
        ...
        ServerObjectManager.instance?._RequestNewMarker(markerPos, markerNormal, markerType)
