...
import { ServerModelMetadata } from "../ModelLoader";
 ...
 export class VRTransformToolCom
 {
   public toolID: any;

   public static instance: VRTransformToolCom | null = null;
   private scene!: Scene;
   ...
   {
      VRTransformToolCom.instance = this;
   ...
   public TryGrab(/*objectMesh:any, */motionController: any, controller: any)
   {
      ...
      if (this.xrHelper.pointerSelection.getMeshUnderPointer)
      {
         ...
         if(grabbedObjTemp && grabbedObjTemp.metadata != null && grabbedObjTemp.metadata instanceof ServerModelMetadata && grabbedObjTemp.metadata.editable )
         {
            ...
            PickingManager.ActiveInstance?.SelectObject(this.grabbedObject);
