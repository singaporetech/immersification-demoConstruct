...
from .room_instance import RoomInstance, RoomPreview

from ...model_database import types as db_types
from ...model_database import document_writer

class RoomFileManager:
    ...
    def save_to_file(self, room_instance: RoomInstance, fileName: str, overwrite_existing: bool = False):
        if len(fileName) == 0:
            fileName = RoomFileManager.DEFAULT_FILE_NAME
    ...
    def save_to_mongodb(self, room_instance: RoomInstance):
        ...
        result = document_writer.upload_unique_object(
            db_types.CollectionType.ROOMS,
            room_instance, 
    ...
    def load_room_instance(self, room_id: int):
        ...
        doc = db_types.collections_dict[db_types.CollectionType.ROOMS].find_one(filter)
